...
public class AbPullToRefreshView extends LinearLayout {
	...
	private void addNoData() {
		noDataView = inflate(mContext, R.layout.refresh_nodata, null);
		LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT,
				LayoutParams.MATCH_PARENT);
		addView(noDataView, params);
		noDataView.setVisibility(View.GONE);
		noDataTips = (TextView) noDataView.findViewById(R.id.nodata);
	 ...
	 * @return true正在刷新
	 */
	public boolean isPullRefresing() {
	 ...
	 *            显示无数据提示
	 */
	public void setNodata(String tips) {
		noDataView.setVisibility(View.VISIBLE);
		noDataTips.setText(tips);
		if (mAdapterView != null) {
			mAdapterView.setVisibility(View.GONE);
		}
		if (mScrollView != null) {
	 ...
	 * @param resId  显示无数据提示
	 */
	public void setNodata(int resId) {
		noDataView.setVisibility(View.VISIBLE);
		noDataTips.setText(resId);
		if (mAdapterView != null) {
			mAdapterView.setVisibility(View.GONE);
		}
		if (mScrollView != null) {
