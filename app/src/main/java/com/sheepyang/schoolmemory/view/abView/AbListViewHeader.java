 ...
 */
package com.sheepyang.schoolmemory.view.abView;
...
import com.sheepyang.schoolmemory.util.DateUtil;
...
//	private ImageView treeView, treeView2;
//	private ImageView deerView;
    ...
    private void initView(Context context) {
        ...
        LayoutParams lp = new LayoutParams(
                LayoutParams.FILL_PARENT, AppUtil.dip2px(context, 100));
        lp.gravity = Gravity.BOTTOM;

//		View view = LayoutInflater.from(context).inflate(R.layout.refresh_head,
//				null);
//		deerView = (ImageView) view.findViewById(R.id.refresh_deer);
//		treeView = (ImageView) view.findViewById(R.id.refresh_tree);
//		treeView2 = (ImageView) view.findViewById(R.id.refresh_tree2);
...
//		deerView.setBackgroundResource(R.anim.refresh_deer_anim);
//		AnimationDrawable anim = (AnimationDrawable) deerView.getBackground();
//		anim.start();
//
//		final Animation animation1 = AnimationUtils.loadAnimation(mContext,
//				R.anim.refresh_tree_anim2);
//		final Animation animation2 = AnimationUtils.loadAnimation(mContext,
//				R.anim.refresh_tree_anim2);
//
...
//				treeView.postDelayed(new Runnable() {
//
//					@Override
//					public void run() {
//						treeView2.setVisibility(View.VISIBLE);
////						treeView.setVisibility(View.INVISIBLE);
//						treeView2.startAnimation(animation2);
//
//					}
//				}, 3000);
//
...
//			@Override
//			public void onAnimationStart(Animation animation) {
//				treeView2.postDelayed(new Runnable() {
//
//					@Override
//					public void run() {
//						treeView.setVisibility(View.VISIBLE);
////						treeView2.setVisibility(View.INVISIBLE);
//						treeView.startAnimation(animation1);
////						treeView2.clearAnimation();
//
//					}
//				}, 3000);
//
